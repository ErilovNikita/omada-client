...
from omada_client.types.models import InternetModel, SiteModel, WanModel
...
def main() -> None:
    ...
    wan_info:InternetModel | None = omada.wan.get_info_all()
    if wan_info and wan_info.wan_port_settings:
        wan_list:list[WanModel] = wan_info.wan_port_settings
        pretty_print(wan_list)
